...
import {ON_METAOBJECT} from './($locale).about';
...
export default function Contact() {
  ...
  const contactSection =
    metaobject.metaobject as App.HomePageTemplate.ContactSection;
        ...
        <div className="contact-form flex-1 space-y-4 md:space-y-6">
          <div className="contact-header w-full">
            <h1
              ...
              className="ft-text-main text-3xl"
            >
              Contact
            </h1>
          </div>
          <div className="form-inputs flex flex-col gap-5 w-full">
            <div className="name">
              <label htmlFor="name">
                <input
                  onChange={(e) => {
