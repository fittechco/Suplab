    ...
    >
      <div className="featuredCollectionsSection__buttons container mb-10">
        <div className='flex justify-between items-center'>
          <p className="ft-text-main md:text-3xl text-2xl w-fit">{fields.title.value}</p>
          <div
            style={{
              padding: '8px 0',
            }}
        ...
        <div className="flex">
          ...
          >
            <button
              ...
              className="ft-text-main btn px-4 py-2 rounded-full text-main text-center w-fit font-bold md:text-xl text-sm uppercase"
            >
              {fields.shop_button_text.value}
            </button>
          </div> */}
