...
export default async function handleRequest(
  ...
  const { nonce, header, NonceProvider } = createContentSecurityPolicy({
    ...
    connectSrc: [
      ...
      "'unsafe-inline'",
      "wss://ws.hotjar.com",
      "Njg1Mjk1ZGYtNmUzOS00MTNiLWJmM2ItM2Q5NGFiYWYwNDVj",
      "Njg1Mjk1ZGYtNmUzOS00MTNiLWJmM2ItM2Q5NGFiYWYwNDVf",
    ...
    scriptSrc: [
      ...
      "nonce-Njg1Mjk1ZGYtNmUzOS00MTNiLWJmM2ItM2Q5NGFiYWYwNDVf",
      "https://suplab.myshopify.com/",
      "https://suplabstore.com/",
      "https://cold-islands-find.loca.lt",
      "https://www.googletagmanager.com",
