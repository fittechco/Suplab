...
import {ON_METAOBJECT} from '~/app/routes/($locale)._index';
    ...
    >
      ...
      >
        <div className="flex flex-col gap-5">
          ...
          <div className={`offers-container overflow-hidden flex-shrink-0`}>
            <div
              style={{
        ...
        <div className="footer-menus / flex flex-col gap-3 / px-5 text-base w-full">
